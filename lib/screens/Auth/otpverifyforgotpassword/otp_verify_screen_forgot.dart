...
import 'package:red_restro/screens/Auth/otpverifyforgotpassword/otp_verify_controller_forgot.dart';

import '../../../components/custom_text_field.dart';

class OtpVerifyScreenForgot extends StatefulWidget {
  const OtpVerifyScreenForgot({super.key});

  @override
  State<OtpVerifyScreenForgot> createState() => _OtpVerifyScreenForgotState();
}

class _OtpVerifyScreenForgotState extends State<OtpVerifyScreenForgot> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  otpVerifyControllerForgot controller = Get.put(otpVerifyControllerForgot());
  @override
